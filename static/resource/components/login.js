define(['module', 'exports', 'React', 'ReactDom'], function (module, exports, _React, _ReactDom) {
		...
		_createClass(Panel, [{
			...
			value: function render() {
				return _React2.default.createElement(
					...
					' ',
					_React2.default.createElement('input', { type: 'text', className: 'input_name' }),
					_React2.default.createElement(
						'span',
						null,
						' \u5BC6\u7801 '
					...
					' ',
					_React2.default.createElement('input', { type: 'text', className: 'input_word' })
				);
			}
		}]);
	...
	exports.default = {
		renderComponent: function renderComponent(opts, element, callback) {
			return _ReactDom2.default.render(_React2.default.createElement(Panel, { opts: opts
			}), element, function () {
				callback && callback();
			});
		}
